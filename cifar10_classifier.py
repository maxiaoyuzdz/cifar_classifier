...
parser.add_argument('-rp', '--resume_path', default='/media/maxiaoyu/checkpoint/cifar10/')
...
parser.add_argument('-logdir', '--log_dir', default='/media/maxiaoyu/data/Log/cifar10/')
...
parser.add_argument('-sp', '--save_model_path', default='/media/maxiaoyu/data/checkpoint/cifar10/')
